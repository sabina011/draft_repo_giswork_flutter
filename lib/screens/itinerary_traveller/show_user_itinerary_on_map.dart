...
import 'itinerary_map/images_list_selected_day.dart';

class ShowUserItineraryInformationOnMap extends StatefulWidget {
  final List<UserItineraryPackageItemsResponse> userItineraryPackageResponse;

  const ShowUserItineraryInformationOnMap({
    Key? key,
    required this.userItineraryPackageResponse,
  }) : super(key: key);

  @override
  State<ShowUserItineraryInformationOnMap> createState() =>
      _ShowUserItineraryInformationOnMapState();
}

class _ShowUserItineraryInformationOnMapState extends State<ShowUserItineraryInformationOnMap> {
  ...
  void initState() {
    ...
    renderItineraryData(markers, widget.userItineraryPackageResponse);
    super.initState();
  }
      ...
      builder: (context, snapshot) {
        ...
        return SafeArea(
          child: Scaffold(
            ...
            persistentFooterButtons(widget.userItineraryPackageResponse),
            body: Container(
              height: size.height,
              width: size.width,
              child: Stack(
                children: [
                  ...
                  Positioned(
                    ...
                    child: Container(
                      width: size.width, // Add width here
                      height: size.height *0.4, // Add height here
  ...
  List<Widget> persistentFooterButtons(
      List<UserItineraryPackageItemsResponse> itineraryShowItemResponse) {
  ...
  void renderItineraryData(List<Marker> markers,
      List<UserItineraryPackageItemsResponse> itineraryShowItemsResponse) {
