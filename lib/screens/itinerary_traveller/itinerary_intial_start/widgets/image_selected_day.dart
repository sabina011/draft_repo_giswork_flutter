...
class ItineraryShowImageListShowSelectedDay extends StatelessWidget {
  ...
  ItineraryShowImageListShowSelectedDay({
    Key? key,
...
void itineraryPlaceInformationFilterAndAssignToNewList(
    List<PlaceInformationItemsResponse> itineraryPlaceInformationResponse,
    List<Map<String, dynamic>> itineraryPlaceInformationIterator) {
